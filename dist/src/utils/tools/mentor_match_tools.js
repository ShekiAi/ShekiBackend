...
exports.getMentorMatchTools = void 0;
// utils/tools/mentor_match_tools.ts
exports.getMentorMatchTools = [
    {
        type: "function",
        function: {
            name: "search_tutors",
            description: "Search GOYE's real tutors by what the student is looking for (a topic, skill, or kind of guidance). Returns real candidates with their bio and the topics of courses they've taught — never invent a tutor that isn't in these results.",
            parameters: {
                type: "object",
                properties: {
    ...
    },
    {
        ...
        function: {
            name: "propose_match",
            description: "Propose connecting the student with a specific tutor from the search_tutors results. This is a terminal action — only call it once you (and ideally the student, if they've reacted to your suggestion) are genuinely comfortable with this match. It notifies the tutor and opens a real chat, so don't call it speculatively.",
            parameters: {
                type: "object",
                properties: {
...
//# sourceMappingURL=mentor_match_tools.js.map