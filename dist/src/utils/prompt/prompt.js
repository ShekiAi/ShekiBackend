...
exports.MENTOR_MATCH_WELCOME_MESSAGE = exports.COURSE_DRAFT_WELCOME_MESSAGE = exports.SEARCH_AGENT_PROMPT = exports.AI_FOR_FETCHING_USERS = exports.AI_LANGUAGE_TRANSLATOR = exports.AI_GUIDANCE_PROMPT = void 0;
exports.COURSE_DRAFT_SYSTEM_PROMPT = COURSE_DRAFT_SYSTEM_PROMPT;
exports.MENTOR_MATCH_SYSTEM_PROMPT = MENTOR_MATCH_SYSTEM_PROMPT;
 ...
 */
function COURSE_DRAFT_SYSTEM_PROMPT(tutorName, draftSummary) {
    return `
...
exports.COURSE_DRAFT_WELCOME_MESSAGE = "Hi! I'm here to help you build your course — just tell me what you'd like to teach, and I'll start putting it together as we talk. You can type or use your voice.";
function MENTOR_MATCH_SYSTEM_PROMPT(studentName, stateSummary) {
    return `
...
exports.MENTOR_MATCH_WELCOME_MESSAGE = "Hi! Tell me a bit about what you're looking for help with, and I'll try to connect you with one of our tutors.";
