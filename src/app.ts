...
apiRouter.post("/ai_v1/course-draft/voice/speak", requireServiceKey, json(), async (req: ExRequest, res: ExResponse) => {
  ...
  try {
    const audio = await VoiceAIService.speak(text, voice);
