...
export const getCourseDraftTools = [
  {
    type: "function",
    function: {
  ...
  },
  {
    ...
    function: {
      name: "add_lesson",
      description:
        "Add a lesson to a module. This never produces a real video — suggested_video_brief is guidance for what the tutor should film later, never a real lesson_video URL.",
      parameters: {
        type: "object",
        properties: {
          moduleDraftId: { type: "string" },
  ...
  },
  {
    ...
    function: {
      name: "add_material",
      description:
        "Add a supplementary material (a document/handout) to the course. Never produces a real document — suggested_content_brief is guidance for what the tutor should write later.",
      parameters: {
        type: "object",
        properties: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Call this ONLY when the tutor has explicitly confirmed the draft looks good and is ready to be created as a real course. This does not create the course itself — it just signals the draft is ready for the tutor's final approval step.",
      parameters: {
        type: "object",
        properties: {
